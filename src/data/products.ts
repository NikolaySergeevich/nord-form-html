...
export const products: Product[] = [
  {
    ...
    category: "garden",
    summary:
      "Архитектурный модуль для участка: хранение, мастерская, дровник и место для техники в одном долговечном объёме.",
    description:
      "Garden Module собирает хозяйственные функции участка в одном спокойном объёме. Внутри можно разделить хранение, рабочую зону и место для крупной техники; снаружи встроенный дровник, дерево и тёплый свет превращают прочную металлическую основу в часть ландшафтной архитектуры. Вместо нескольких разрозненных построек появляется один продуманный объект.",
    heroImage: {
    ...
    materials: [
      ...
      },
      {
        ...
        description: "Тёплая вертикальная отделка смягчает фасад, задаёт ритм и связывает объект с ландшафтом."
      },
      {
        id: "osb-interior",
        title: "ОСБ внутри",
  ...
  },
  {
    ...
    description:
      "Хозяйственный модуль освобождает участок от случайных сараев и разрозненного хранения. Внутри размещаются техника, инструмент, стеллажи и сезонные вещи, а наружный дровник остаётся сухим и доступным. Графитовый корпус, дерево и спокойная подсветка делают утилитарную функцию частью архитектуры участка.",
    heroImage: {
    ...
    materials: [
      ...
      },
      {
        ...
        description: "Свет выделяет рельеф металла, подчёркивает входы и делает объект собранным вечером."
      }
    ],
  ...
  },
  {
    ...
    category: "spa",
    summary:
      "Банный сценарий в одном модуле: комната отдыха, моечная, парная и отдельная зона для инженерии.",
    description:
      "SPA Bath Bany спроектирована как последовательное пространство: от сухой комнаты отдыха к моечной и парной. Коммуникации вынесены в техническую нишу, поэтому обслуживание не занимает полезную площадь. Снаружи графитовый металл, дерево, дровник и мягкий свет формируют современный SPA-объект для долгой сезонной или круглогодичной эксплуатации.",
    heroImage: {
    ...
    materials: [
      {
        ...
        description: "Тёплая отделка формирует спокойное банное пространство и поддерживает правильное ощущение масштаба."
      },
      {
  ...
  },
  {
    ...
    category: "business",
    summary:
      "Архитектурная основа для цветочного бренда: витрина, рабочий сценарий, хранение и инженерия в одном объёме.",
    description:
      "Workshop Flowers Module объединяет пространство для клиентов и ежедневную работу флориста. Крупная витрина открывает интерьер городу, а внутри размещаются экспозиция, рабочая стойка и хранение упаковки. Вывеска, тёплый свет, климат и деревянные акценты создают торговую точку, которая выглядит как часть бренда, а не временный павильон.",
    heroImage: {
