...
export const blogCategories = [
  {
    slug: "uchastok",
    title: "Для участка",
    description: "Хранение, дровники, техника и визуальный порядок на загородном участке."
  },
  {
    slug: "spa",
    title: "SPA и баня",
...
export const blogArticles: BlogArticle[] = [
  {
    id: "modern-sauna",
    slug: "modern-sauna",
    title: "Модульная баня: логика зон",
    excerpt:
  ...
  },
  {
    id: "storage-ideas",
    slug: "storage-ideas",
    title: "Хранение на участке без временных построек",
    excerpt:
  ...
  },
  {
    id: "flower-shop",
    slug: "flower-shop",
    title: "Цветочный магазин в модульном формате",
    excerpt:
