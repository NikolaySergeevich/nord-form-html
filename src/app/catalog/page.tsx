          ...
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
            <Reveal>
              <SectionHeader
                ...
                title="Первый шаг к своему пространству."
                description="Укажите контакт — мы отправим каталог с основными направлениями. Если потребуется, поможем выбрать формат под участок или бизнес."
              />
            </Reveal>
            <Reveal delay={0.08}>
