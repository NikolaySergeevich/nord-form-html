  ...
  return (
    <>
      <HeroSection
        ...
        title="Каждая деталь производства должна поддерживать архитектурную идею."
        description="Мы заранее связываем конструкцию, планировку, инженерные системы, фасад и условия установки. Так образ на рендере превращается в понятный, долговечный и технически реализуемый объект."
        image={{
        ...
        <Container>
          <Reveal>
            <SectionHeader
              ...
              title="Полноценное здание рождается там, где эстетика и технология не спорят друг с другом."
              description="Каждый сварной шов, каждый проём, каждый элемент фасада и каждая линия подсветки становятся частью единой архитектурной идеи. Поэтому технические решения принимаются не отдельно от образа, а вместе с ним."
            />
          </Reveal>
