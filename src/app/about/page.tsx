...
export default function AboutPage() {
  return (
    <>
      <HeroSection
        eyebrow="О компании"
        title="Nord Form создаёт современные пространства из промышленной основы."
        description="Мы верим, что модульное здание может быть не компромиссом, а точной архитектурой: спокойной, функциональной, долговечной и визуально собранной."
        image={{
        ...
        <Container>
          <Reveal>
            <SectionHeader
              ...
              title="Мы начинали не с желания производить больше объектов, а с вопроса: почему небольшая постройка редко получает право быть красивой?"
