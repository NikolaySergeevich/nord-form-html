        ...
        <Container className="py-20">
          <Reveal>
            <div className="mx-auto max-w-3xl text-lg leading-8 text-text-secondary">
              <p>
                Перед выбором модуля важно сформулировать не только желаемый внешний вид,
                но и ежедневный сценарий: кто будет пользоваться пространством, что должно
                находиться внутри и в какое время года объект будет работать.
              </p>
              <p className="mt-6">
                На консультации мы связываем эти требования с участком, конструкцией,
                инженерией и комплектацией. Так решение формируется вокруг реальной задачи,
                а не вокруг набора случайных опций.
              </p>
          ...
          <Container>
            <Reveal>
              <div className="max-w-3xl">
                ...
                <h2>Решения, в которых этот подход уже заложен.</h2>
              </div>
            </Reveal>
            <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
