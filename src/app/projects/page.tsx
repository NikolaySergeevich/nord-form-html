...
export default function ProjectsPage() {
  return (
    <>
      <HeroSection
        eyebrow="Проекты"
        title="Практическая задача. Архитектурный результат."
        description="Показываем, как сценарий, конструкция, материалы и свет собираются в цельное пространство — для участка, отдыха или бизнеса."
        image={{
        ...
        <Container>
          <Reveal>
            <SectionHeader
              ...
              title="Разные задачи. Единая логика."
              description="В каждом проекте назначение, планировка, инженерия и фасад работают как одно решение — без ощущения временной постройки."
            />
          </Reveal>
