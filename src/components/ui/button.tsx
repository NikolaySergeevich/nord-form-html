...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-sm text-[0.8125rem] font-semibold uppercase tracking-[0.12em] transition-all duration-300 active:translate-y-px active:shadow-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2 focus-visible:ring-offset-background-primary disabled:pointer-events-none disabled:translate-y-0 disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
