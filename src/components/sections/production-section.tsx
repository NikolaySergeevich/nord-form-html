        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          ...
          <Reveal delay={0.1}>
            <SectionHeader
              ...
              title="Производство продолжает архитектуру."
              description="Сварной шов, проём, фасадная линия и точка света должны поддерживать общий замысел. Поэтому мы связываем сценарий, конструкцию и детали до того, как модуль отправится в работу."
