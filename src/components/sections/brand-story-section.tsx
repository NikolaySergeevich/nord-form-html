          ...
          <Reveal delay={0.08}>
            <div className="rounded-md border border-border/80 bg-surface-primary p-6 shadow-sm md:p-8">
              ...
              <p className="mt-5 text-2xl leading-snug text-text-primary md:text-3xl">
                В основе каждого проекта — морской контейнер, который проходит путь от промышленного объекта до современной архитектуры.
              </p>
              <p className="mt-5 text-text-secondary">
                Мы сохраняем его прочность и честную металлическую природу, но добавляем пропорции, планировку, дерево, свет и инженерную логику. Так появляется не временная постройка, а пространство с характером.
              </p>
            </div>
          </Reveal>
        </div>
