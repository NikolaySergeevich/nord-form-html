...
const reasons = [
  {
    title: "Не оболочка, а пространство",
  ...
  {
    title: "Промышленная основа. Человеческий масштаб.",
        ...
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <Reveal>
            <SectionHeader
              ...
              title="Архитектура держится на инженерии."
              description="Nord Form существует для тех, кто не хочет выбирать между практичностью и эстетикой. Мы проектируем модульные здания как часть среды: с ясной функцией, точной конструкцией и спокойным визуальным характером."
            />
          </Reveal>
